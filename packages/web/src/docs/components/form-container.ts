...
const doc: ComponentDoc = {
  ...
  schemas: [
    {
      title: '基础用法',
      description: '作为审批表单的顶层容器，包裹表单内容',
      schema: [
        {
          type: 'page',
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    ...
                    { type: 'grid-col', span: 8, children: [{ type: 'input', field: 'fc_applicant', props: { placeholder: '请输入申请人' } }] },
                    { type: 'grid-col', span: 4, label: '部门', align: 'center' },
                    { type: 'grid-col', span: 8, children: [{ type: 'input', field: 'fc_dept', props: { placeholder: '请输入部门' } }] },
                  ],
                },
                {
                  type: 'grid-row',
                  children: [
                    ...
                    { type: 'grid-col', span: 20, children: [{ type: 'textarea', field: 'fc_reason', props: { placeholder: '请输入申请事由', rows: 4 } }] },
                  ],
                },
              ],
            },
