...
import { View, Plus, Connection } from '@element-plus/icons-vue'
import type { WorkflowTemplateItem } from '@schema-form/shared-utils/apiClient'
...
const categoryTagType = computed(() => CATEGORY_TAG_TYPE[props.template.category] ?? 'info')
