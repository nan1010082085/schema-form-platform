...
import { Document, ArrowRight, ArrowDown } from '@element-plus/icons-vue'
...
<template>
  <div :class="styles.container">
    ...
    <aside :class="styles.sidebar">
      ...
      <el-scrollbar :class="styles.sidebarScroll">
        <div
    ...
    <main :class="styles.content">
      <el-scrollbar :class="styles.contentScroll">
        ...
        <div v-else :class="styles.empty">
          <el-icon :size="64" :class="styles.emptyIcon"><Document /></el-icon>
