      ...
      <div v-else-if="detail" :class="styles.root">
        ...
        <div :class="styles.overview">
          ...
          <div :class="styles.overviewRow">
            ...
            <t-tag :theme="statusTheme(detail.status)" size="small">
        ...
        <div :class="styles.timeline">
          ...
          >
            ...
            <div :class="styles.timelineContent">
              ...
              <t-collapse v-if="Object.keys(node.input ?? {}).length > 0 || Object.keys(node.output ?? {}).length > 0">
                <t-collapse-panel value="io" header="输入/输出数据">
