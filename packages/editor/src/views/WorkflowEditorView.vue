  ...
  <div :class="styles.workflowEditor">
    ...
    <div :class="styles.header">
      <div :class="styles.headerLeft">
        ...
        <t-tag
          v-if="isEditing"
          :theme="workflowStatus === 'published' ? 'success' : 'default'"
      ...
      <div :class="styles.headerRight">
        <t-button :loading="saving" @click="handleSave">
          保存
        </t-button>
        <t-button
    ...
    <div :class="styles.stepsWrapper">
      <t-steps :current="currentStep + 1" status="finish" layout="horizontal">
        <t-step
    ...
    <div :class="styles.body">
          ...
          <template v-if="currentStep === 0">
            <div :class="styles.stepSection">
              ...
              <div :class="styles.selectRow">
                ...
                <t-button :class="styles.createLink" @click="goToCreateSchema">
            ...
            <!-- 表单预览 -->
            <t-card v-if="selectedSchemaDetail" :class="styles.previewCard" :bordered="true">
              <template #header>
                <div :class="styles.previewCardHeader">
                  <span :class="styles.previewCardTitle">表单信息</span>
                  <t-tag size="small" theme="default">{{ selectedSchemaDetail.type }}</t-tag>
                </div>
              </template>
          ...
          <template v-if="currentStep === 1">
            <div :class="styles.stepSection">
              ...
              <div :class="styles.selectRow">
                ...
                <t-button :class="styles.createLink" @click="goToCreateFlow">
                  <template #icon><AddIcon /></template>
                  创建新流程
                </t-button>
              </div>
            ...
            <!-- 流程预览 -->
            <t-card v-if="selectedFlow" :class="styles.previewCard" :bordered="true">
              <template #header>
                <div :class="styles.previewCardHeader">
                  <span :class="styles.previewCardTitle">流程信息</span>
                  <t-tag size="small" :theme="selectedFlow.status === 'published' ? 'success' : 'default'">
          ...
          <template v-if="currentStep === 2">
            <div :class="styles.stepSection">
              ...
              <div v-if="dataUpdateRules.length === 0" :class="styles.emptyRules">
                ...
                <t-button size="small" @click="addRule">添加第一条规则</t-button>
              </div>
      ...
      <div :class="styles.footer">
        <div :class="styles.footerLeft">
          <t-button v-if="currentStep > 0" @click="handlePrev">
            上一步
          </t-button>
        </div>
