...
const statusThemeMap: Record<string, 'primary' | 'success' | 'danger' | 'warning'> = {
  running: 'primary',
  completed: 'success',
  terminated: 'danger',
  suspended: 'warning',
...
<template>
  <div :class="styles.page">
    ...
    <div :class="styles.header">
      <div :class="styles.headerLeft">
        ...
        <t-tag
          ...
          :theme="statusThemeMap[instance.status] ?? 'default'"
          size="small"
        >
      ...
      <div :class="styles.headerRight">
        <t-button size="small" @click="router.push(`/workflow/${workflowId}/preview`)">
          预览工作流
        </t-button>
      </div>
    </div>
    ...
    <div v-else-if="error" :class="styles.errorState">
      <CloseCircleFilledIcon :size="48" color="var(--td-error-color)" />
      <p>{{ error }}</p>
      <t-button @click="handleBack">返回工作流列表</t-button>
    </div>
        ...
        <div :class="styles.content" style="max-width: 960px;">
          <div :class="styles.card">
            <div :class="styles.cardHeader">
              ...
              <t-tag size="small" theme="default">{{ instancesTotal }} 个实例</t-tag>
            </div>
            <div :class="styles.cardBody">
              ...
              <t-table
                ...
                :data="instances"
                :columns="[
                  { colKey: 'id', title: '实例 ID', width: 280, ellipsis: true },
              ...
              >
                <template #status="{ row }">
                  <t-tag
                    :theme="statusThemeMap[row.status] ?? 'default'"
                    size="small"
                  >
          ...
          <div :class="styles.leftCol">
              ...
              <div :class="styles.cardBody">
                ...
                <div v-else :class="styles.progressTimeline">
                  ...
                  >
                    ...
                    >
                      <LoadingIcon v-if="node.tokenState === 'active'" :size="12" />
                      <CheckCircleFilledIcon v-else-if="node.tokenState === 'completed'" :size="12" />
                    </div>
            ...
            <div :class="styles.historyCard">
              <div :class="styles.cardHeader">
                ...
                <t-tag size="small" theme="default">{{ approvalLogs.length }} 条记录</t-tag>
              </div>
              <div :class="styles.cardBody">
